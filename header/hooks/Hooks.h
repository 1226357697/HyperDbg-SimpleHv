...
/**
 * @brief �Զ��жϲ���װ EPT Inline Hook (R0/R3 ����Ӧ)
 * @details ����Ŀ���ַ�Զ��ж����ں˺��������û�������
 *          ��ʹ�ú��ʵ� CR3 ���� Hook��֧�ֿ�ҳ��⡢��ַ��֤����ϸ��־��
 *
 * @param TargetAddress Ҫ Hook ��Ŀ���ַ��֧�� R0/R3 �Զ���⣩
 * @param HookFunction Hook ����������ַ
 * @param ProcessId ���� ID�������� R3 ��ַ��
 *                  - 0: ���� R3 ��ַʹ�õ����߽��̣����� R0 ��ַ����
 *                  - �� 0: ���� R3 ��ַʹ��ָ�����̣����� R0 ��ַ����
 *

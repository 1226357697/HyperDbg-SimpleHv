...
/**
 * @brief error, the target function crosses page boundary，HOOK跨页了
 *
 */
#define DEBUGGER_ERROR_FUNCTION_CROSSES_PAGE_BOUNDARY 0xc0000030

 /**
  * @brief error, invalid process ID provided，进程ID不正确
  *
  */
#define DEBUGGER_ERROR_INVALID_PROCESS_ID 0xc0000031
                              ...
                              VMX_EXIT_QUALIFICATION_MOV_CR * CrExitQualification)
{
    ...
    */
    ...
    case VMX_EXIT_QUALIFICATION_ACCESS_MOV_TO_CR:
    {
        ...
        default:
            SimpleHvLogWarning("Unsupported register 0x%x in handling control registers access",
    ...
    default:
        SimpleHvLogWarning("Unsupported operation 0x%x in handling control registers access",
